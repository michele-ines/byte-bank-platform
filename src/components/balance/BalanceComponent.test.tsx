...
jest.mock('../utils/currency-formatte', () => ({
...
describe('BalanceComponent', () => {
  ...
  describe('Basic rendering', () => {
    ...
    it('should render the current formatted date', () => {
      ...
      // Check if any date is being rendered
  ...
  describe('User handling', () => {
    ...
    it('should show only first name even with compound names', () => {
      const propsWithCompoundName = {
        ...defaultProps,
        user: { ...mockUser, name: 'Maria José da Silva Santos' },
      };
  ...
  describe('Decorative elements', () => {
    it('should render decorative elements with accessibility disabled', () => {
      render(<Balance {...defaultProps} />);
      
      // Check if decorative elements are present but not accessible
      const decorativeElements = screen.getAllByTestId(/decorative/i);
  ...
  describe('formatBRL integration', () => {
    it('should call formatBRL with correct value', () => {
      const { formatBRL } = require('../utils/currency-formatte');
